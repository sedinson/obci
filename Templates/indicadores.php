        ...
        <div id="wrapper">
            <div id="header">
                <div class="wrapper B234">
                    ...
                    <ul class="menu">
                        <li><a class="select" href="<?php echo Link::Url('indicadores'); ?>">Indicadores</a></li>
                ...
                <div id="selfcontent">
                    <div id="menu-indicador">
                        <div class="leftside-menu">
                            <h2>Importacion / Exportacion</h2>
                            <ul>
                                <li><a href="<?php echo Link::Url('indicadores', 'expoimpo'); ?>">Por Departamentos</a></li>
                                <li><a href="<?php echo Link::Url('indicadores', 'puertos'); ?>">Por Puertos</a></li>
                                <li><a href="<?php echo Link::Url('indicadores', 'expoimpopaises'); ?>">Por Paises</a></li>
                                <li><a href="<?php echo Link::Url('indicadores', 'zonafranca'); ?>">Por Zona Franca</a></li>
                                <li><a href="<?php echo Link::Url('indicadores', 'zfpaises'); ?>">Por Zona Franca (Origen/Destino)</a></li>
                            </ul>

                            <h2>Capitulos</h2>
                            <ul>
                                <li><a href="<?php echo Link::Url('indicadores', 'rca'); ?>">Por Departamentos</a></li>
                            </ul>

                            <h2>Otros Indicadores</h2>
                            <ul>
                                <li><a href="<?php echo Link::Url('indicadores', 'caribeexpo'); ?>">Exportaciones Caribe</a></li>
                                <li><a href="<?php echo Link::Url('indicadores', 'aperturabalanza'); ?>">Indice de Ventaja Comparativa Revelada por Paises</a></li>
                                <li><a href="<?php echo Link::Url('indicadores', 'ihh'); ?>">Indice de Concentración de Exportaciones (IHH)</a></li>
                            </ul>

                            <p style="margin: 50px 20px 0 20px;color: #1d1d1b;">
                                Para saber como se realizan estos calculos <a style="font-weight: 600;color:#fff;" href="<?php echo Link::Absolute('Resource/plantillas/Manual_Indicadores.pdf'); ?>">haz clic aqui</a>.
                            </p>
                        </div>
                    ...
                    <div class="wrapper semiwrapper">
                        ...
                        <div>
                            ...
                            <ul class="leyendas">
                                <li><b>K: </b>1.000</li>
                                <li><b>M: </b>1.000.000</li>
                                <li><b>G: </b>1.000.000.000</li>
                                <li><b>T: </b>1.000.000.000.000</li>
                            </ul>
                        </div>
                    </div>
                </div>
